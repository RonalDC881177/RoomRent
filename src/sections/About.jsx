...
const About = () => {
  ...
  return (
    <section id='about' className={`${darkMode ? "dark bg-[#0b2236]" : "light bg-transparent"} w-full m-auto lg:px-40 px-10 py-20 grid lg:grid-cols-2 grid-cols-1 justify-center items-center gap-10`}>
      <div>
